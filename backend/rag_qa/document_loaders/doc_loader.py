...
from docx import Document as Docu1  # 用于读取Word文档
from docx.document import Document as Docu2 # 用于处理Word文档的XML结构
...
class OCRDOCLoader(BaseLoader):
    ...
    def lazy_load(self) -> Iterator[Document]:
        ...
        line = self.doc2text(self.file_path)
...
if __name__ == '__main__':
    ...
    docx_loader = OCRDOCLoader(file_path="./data/test.docx")
